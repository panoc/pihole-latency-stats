...
1. Download the script:
   ```bash
   wget -O [https://raw.githubusercontent.com/panoc/pihole-latency-stats/main/pihole_stats.sh](https://raw.githubusercontent.com/panoc/pihole-latency-stats/main/pihole_stats.sh)
